            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="prop_size_prefix" class="form-control" name="prop_size_prefix" <?php if( $area_prefix_changeable != 1 ){ echo 'disabled'; }?> value="<?php echo esc_html($area_prefix_default);?>">
                    </div>
                </div>
                <?php } ?>
                ...
                <?php if( $hide_add_prop_fields['land_area'] != 1 ) { ?>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" <?php if( $area_prefix_changeable != 1 ){ echo 'disabled'; }?> id="prop_land_area_prefix" class="form-control" name="prop_land_area_prefix" value="<?php echo esc_html($area_prefix_default);?>">
                        </div>
                    </div>
                <?php } ?>
            ...
            <table class="additional-block">
                ...
                <tr>
                    ...
                    <td class="field-title">
                        <input class="form-control" type="text" name="additional_features[0][fave_additional_feature_title]" id="fave_additional_feature_title_0" value="<?php esc_html_e( 'Eg: Equipment', 'houzez' ); ?>">
                    </td>
                    <td>
                        <input class="form-control" type="text" name="additional_features[0][fave_additional_feature_value]" id="fave_additional_feature_value_0" value="<?php esc_html_e( 'Grill - Gas', 'houzez' ); ?>">
                    </td>
                    <td class="action-field">
