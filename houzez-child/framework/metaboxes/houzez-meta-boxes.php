...
if( !function_exists( 'houzez_register_metaboxes' ) ) {
    function houzez_register_metaboxes() {
		...
		*/
                ...
                'multi_units' => array(
                    'label' => esc_html__('Additional Buildings', 'houzez'),
		...
		*/
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'desc' => esc_html__('Eg: 500,000', 'houzez'),
                    'type' => 'text',
                    'std' => "",
                    'columns' => 6,
                ...
                array(
                    ...
                    'desc' => esc_html__('Eg: Acres', 'houzez'),
                    'type' => 'text',
                    'std' => "",
                    'class' => $land_area,
                    'columns' => 6,
                ...
                array(
                    ...
                    'name' => esc_html__('Additional Buildings', 'houzez'),
                ...
                array(
                    ...
                    // Sub-fields
                    'fields' => array(
                        /* ============ to hide title and price options ================
			array(
                        ...
                        array(
                            'name' => esc_html__( 'Building Size', 'houzez' ),
