    ...
    <div class="top-footer container-fluid">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-1">
                <img src="http://omahahls.com/lashleytemp/wp-content/uploads/2016/11/logowhite-1.png">
            </div>
            <div class="col-sm-6">
                <p>2218 E. Walker Road • North Platte, NE 69101</p>
                <p>Phone: 308-532-9300 • Fax: 308-532-1854 • Email Us</p>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-8 col-md-6">
                <div class="footer-col">
                    <p class="text-center">© Lashley Land and Recreational Brokers, Inc.</p>
                </div>
            </div>
