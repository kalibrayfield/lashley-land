...
$kml_map_file_id = get_post_meta(get_the_ID(), 'property_kml_file', true);
$kml_map_file_url = wp_get_attachment_url($kml_map_file_id);

?>
<div id="address" class="detail-address detail-block target-block">
    <div class="detail-title">
        <h2 class="title-left"><?php esc_html_e( 'Map', 'houzez' ); ?></h2>
        ...
        <?php } ?>
	 <?php if (!empty($kml_map_file_url)) { ?>
            <div id="kml_map_url" data-url="<?php echo $kml_map_file_url; ?>"></div>
            <div id="kml_map"></div>
        <?php } ?>
    </div>
