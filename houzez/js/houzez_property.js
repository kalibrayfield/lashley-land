...
jQuery(document).ready( function($) {
    ...
    if ( typeof houzezProperty !== "undefined" ) {
        ...
        //Login user before submit property
        ...
        var property_gallery_images = function() {
            ...
            uploader.bind('FileUploaded', function ( up, file, ajax_response ) {
                ...
                if ( response.success ) {
                    ...
                    var proppertyThumbHtml = '<figure class="gallery-thumb">' +
        ...
        var thread_message_attachment = function() {
            ...
            /* initialize uploader */
            var uploader = new plupload.Uploader({
                browse_button: 'thread-message-attachment',          // this can be an id of a DOM element or the DOM element itself
                file_data_name: 'property_upload_file',
                container: 'property-thumbs-container',
                drop_element: 'drag-and-drop-messages',
                multi_selection: true,
                url: ajax_url + "?action=houzez_message_attacment_upload&nonce=" + uploadNonce,
                filters: {
            ...
            /* Run during upload */
            uploader.bind('UploadProgress', function(up, file) {
                document.getElementById( "holder-" + file.id ).innerHTML = '<li><lable>' + file.name + '<span>' + file.percent + "%</span></lable></li>";
            });
            ...
            uploader.bind('FileUploaded', function ( up, file, ajax_response ) {
                ...
                if ( response.success ) {
                    ...
                    messageAttachment();  // bind click event with newly added gallery thumb
