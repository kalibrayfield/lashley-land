...
<header id="header-section" data-sticky="<?php echo esc_attr( $main_menu_sticky ); ?>" class="houzez-header-main <?php echo esc_attr( $css_class ).' '.esc_attr( $header_1_menu_align ).' '.esc_attr($menu_righ_no_user).' '.esc_attr($houzez_user_logout); ?> hidden-sm hidden-xs">
