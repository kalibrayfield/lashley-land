...
if( $enable_contact_form_7_prop_detail != 0 ) {
    ...
    <?php
        ...
        if ($agent_email) { ?>
                ...
                <div class="form-group">
                <textarea class="form-control" name="message" rows="5" placeholder="<?php esc_html_e('Description', 'houzez'); ?>"><?php _e("Hello, I am interested in", "houzez"); ?> [<?php echo get_the_title(); ?>]</textarea>
                </div>
