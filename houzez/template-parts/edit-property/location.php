 ...
 * Time: 5:45 PM
 */
global $prop_meta_data, $prop_data, $required_fields, $hide_add_prop_fields;
        ...
        <div class="add-tab-row  push-padding-bottom">
            <div class="row">
                    ...
                    <div class="col-sm-6 submit_country_field">
                        <div class="form-group">
                            ...
                            <?php if( $location_dropdowns == 'yes' ) { ?>
                                <select name="country_short" id="country_short" class="selectpicker" data-live-search="true">
                                    <?php
                ...
                <?php if ($hide_add_prop_fields['state'] != 1) { ?>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="countyState"><?php echo esc_html__( 'County / State', 'houzez' ).houzez_required_field( $required_fields['state'] ); ?></label>
                            <?php if( $location_dropdowns == 'yes' ) { ?>
                                <select name="administrative_area_level_1" id="countyState" class="selectpicker" data-live-search="true">
                ...
                <?php if ($hide_add_prop_fields['city'] != 1) { ?>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="city"><?php echo esc_html__( 'City', 'houzez' ).houzez_required_field( $required_fields['city'] ); ?></label>
                            <?php if( $location_dropdowns == 'yes' ) { ?>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="neighborhood"><?php echo esc_html__( 'Neighborhood', 'houzez' ).houzez_required_field( $required_fields['neighborhood'] ); ?></label>
                        <?php if( $location_dropdowns == 'yes' ) { ?>
