        ...
        <div class="media-body media-middle">
            ...
            <div class="my-actions">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu actions-dropdown">
                        ...
                        if(!empty($delete_post_link)){
                            ?>
                        <li><a onclick="return confirm('<?php esc_html_e( 'Are you sure you wish to delete?', 'houzez' ); ?>')" href="<?php echo esc_url( $delete_post_link ); ?>"><i class="fa fa-close"></i> <?php esc_html_e('Delete', 'houzez');?></a></li>
                            <?php
                        }?>
                ...
                if( houzez_check_post_status( $post->ID ) ) {
                    ...
                    //Free Listings
                    if( $paid_submission_type == 'no' && $property_status_text == 'publish' ) {
                        echo '<div class="btn-group">';
                        if( $prop_featured != 1 ) {
                            echo '<a href="#" data-proptype="free" data-propid="'.intval( $post->ID ).'" class="make-prop-featured btn pay-btn">' . esc_html__('Set as Featured', 'houzez') . '</a>';
                        }
                        echo '</div>';
                    }
