        ...
        <form id="submit_property_form" name="new_post" method="post" action="" enctype="multipart/form-data" class="update-frontend-property">
            ...
            <div class="steps-nav">
                <div class="btn-left btn-back action">
                    <button type="button" class="btn"><i class="fa fa-angle-left"></i></button> <?php esc_html_e('Back', 'houzez'); ?>
                </div>
                <div class="btn-right btn-next action">
                    <?php esc_html_e('Next', 'houzez'); ?> <button type="button" class="btn"><i class="fa fa-angle-right"></i></button>
                </div>
                <div class="btn-right action btn-submit btn-step-submit">
                    <?php esc_html_e('Update Property', 'houzez'); ?> <button <?php if ( !is_user_logged_in() ) { ?> disabled="disabled" <?php } ?> id="update_property" type="submit" class="btn"><i class="fa fa-angle-right"></i></button>
                </div>
            </div>
        </form>
